MX.getAllSQLInfo = function(SERVER, coID = 'sa', coPD = 'moldev'){
  ...
  ch <- odbcConnect(SERVER, uid = coID, pwd = coPD) #Open DataBase
  ...
  #
  FileLoc$ImFullPath = paste(gsub('[\\]','/',FileLoc$SERVER_NAME),FileLoc$ImPath,sep='')
